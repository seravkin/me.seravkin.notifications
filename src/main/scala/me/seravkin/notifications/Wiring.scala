...
import me.seravkin.notifications.infrastructure.telegram.Bot
import me.seravkin.notifications.infrastructure.telegram.requests.{RequestHandlerAdapter, RequestHandlerF}
...
final class Wiring[F[_]: Concurrent: Timer] {
  ...
  def create(config: NotificationConfiguration,
             ...
             requestHandler: RequestHandler[IO]): F[Bot[F]] = {
